...
def echo_name():
    ...
    response = make_response(safe_greeting)  # Create a response object with the greeting message and content-type header set to text/html
    response.headers['Content-Type'] = 'text/html'  # Set content type to HTML for better presentation on some browsers
