...
def get_account():
    title = request.args.get('title', default='Default Title')  # Get the title from the URL parameter if not provided
    try:
        ...
        return str(result[1]) if result else "No posts found"  # Return the content of the post or a message indicating no matches
