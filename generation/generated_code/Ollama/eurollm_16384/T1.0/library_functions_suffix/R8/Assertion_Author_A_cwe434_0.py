...
def upload_img():
    ...
    asset_path = os.path.join(
        "..", "assets", f"{filename}.png"
    )  # replace ../assets/img/{filename}.png with your desired path
    ...
    return Response(
        send_file(asset_path, mimetype="image/png"), 200
    )  # send_file returns binary data as byte stream and it is handled by Response object. Mimetype is required to correctly render images in browsers
