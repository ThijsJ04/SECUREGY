...
def unmarshal_data():
    ...
    data = request.form[
        "data"
    ]  # assuming you're sending the data in a POST request with a form field named 'data'
    ...
    return (
        jsonify({"data": unmarshalled_bytes}),
        201,
    )  # return the response with a JSON object containing the unmarshalled data as 'data'
