...
def echo_name():
    ...
    try:
        ...
        first_name = request.args[
            "first_name"
        ]  # or any other parameter name you defined
    except KeyError as e:
        status_code = 400
        return make_response(
            make_response("Error", "", status=status_code), status_code
        )
    ...
    return make_response(
        make_response(personalized_greeting, 200), 200
    )  # or any other response status code you like
