...
def login():
    ...
    check_password_hash(user.password_hash, password)  # Check if the password matches the stored hash
    ...
    return jsonify({"message": "Authenticated successfully", "user": authenticated_user})