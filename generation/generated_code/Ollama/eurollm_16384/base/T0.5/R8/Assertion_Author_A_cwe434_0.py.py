...
app = Flask(__name__)
UPLOAD_FOLDER = '../assets/img'  # Change this to the actual path where you want to store the images
...
def upload_img():
    ...
    if file and allowed_extensions.__contains__(file.filename.rsplit('.', 1)[1].lower()):
        if '.' in filename:
