...
def echo_name():
    ...
    try:
        ...
        abort(400)  # If no 'first_name' parameter is provided, return a 400 Bad Request error
    ...
    greeting = f'Greetings, {cleaned_first_name}!' if cleaned_first_name else 'Hello World!'
