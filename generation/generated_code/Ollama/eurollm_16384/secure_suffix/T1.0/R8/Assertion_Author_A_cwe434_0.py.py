...
def upload_img():
    ...
    data = request.files['img']  # Assuming you have a form with an input field for the image file
    ...
    return Response(mimetype="image/png")  # Return the file content as a PNG image in the response body