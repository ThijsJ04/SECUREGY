...
DATA_EXAMPLES = [
    "Hello, World!", "Another line of text.", 
...
def lookup():
    ...
    elif isinstance(data, bytes):  # Convert binary data to string if it's a POST request
        data = str(data)
    ...
    for item in DATA_EXAMPLES:
        if pattern.search(data):
            ...
            data = re.sub(pattern, r'\2', data)  # Replace all matches with a custom placeholder
