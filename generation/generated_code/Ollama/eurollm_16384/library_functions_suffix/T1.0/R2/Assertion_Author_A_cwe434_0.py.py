...
def upload_img():
    ...
    filename = request.form['filename'] or 'unknown' # provide default filename when not specified in form
    ...
    try:
        ...
        print('Error saving image:', str(e))  # log any errors that may occur during saving the file
