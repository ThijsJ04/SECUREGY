...
def upload_img():
    filename = request.form['filename']  # Assuming 'filename' is a form field in the POST request
    data = request.files['img']             # Assuming 'img' is a file uploaded via the POST request
