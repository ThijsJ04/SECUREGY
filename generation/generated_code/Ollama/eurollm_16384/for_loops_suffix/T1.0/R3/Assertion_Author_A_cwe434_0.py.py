...
def upload_img():
    ...
    try:
        ...
        return Response(status=500)  # Return a 500 Internal Server Error with error message
    ...
    try:
        ...
        print("Error writing image to file:", str(e))  # Log the error for debugging purposes
        return Response(status=500)  # Return a 500 Internal Server Error with error message

    return Response(status=200, headers={"Content-Type": "image/png"}, body="Image saved successfully")