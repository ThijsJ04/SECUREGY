...
def upload_img():
    ...
    img = request.files['img']               # img is a file-like object, use decode to convert it into bytes
    img_bytes = base64.b64decode(img)       # decodes base64 encoded data and returns an array of bytes
