...
def unmarshal_data():
    ...
    try:
        ...
        serialized_data = request.get_json().get('data')  # Assuming JSON is passed in as 'data' key
    except KeyError:
    ...
    try:
        ...
        return f"Error: Invalid data format ({e}): {serialized_data}", 400  # Return the error message and the serialized data
