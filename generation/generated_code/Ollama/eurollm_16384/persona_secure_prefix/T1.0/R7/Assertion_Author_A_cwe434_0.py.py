...
app = Flask(__name__)
app.config["UPLOAD_FOLDER"] = "../assets/img"  # Change this to your local path if needed
...
def upload_img():
    if request.method == "POST":
        ...
        if file and allowed_file(filename):
            ...
            original_img_data = base64.b64decode(request.files["file"].read())  # get the original image data from "img" parameter
