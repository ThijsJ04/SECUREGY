...
def upload_img():
    ...
    filename = request.args.get("filename") or "unknown"  # If not provided, default to "unknown"
    temp_file = request.files["img"]  # Assuming "img" is the key for the image file in the request form data
