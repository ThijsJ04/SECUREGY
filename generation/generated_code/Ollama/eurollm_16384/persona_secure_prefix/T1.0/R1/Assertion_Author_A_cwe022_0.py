...
def deleteImage():
    ...
    filename, file_extension = os.path.splitext(path) # Split the file extension from the path
    try:
    ...
    except FileNotFoundError:   # If the file does not exist, return "The file does not exist"
