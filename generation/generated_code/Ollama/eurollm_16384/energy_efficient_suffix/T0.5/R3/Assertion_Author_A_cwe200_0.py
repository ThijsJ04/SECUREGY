...
def login():
    ...
    except Exception as e:  # If the token verification fails, return an error message
        return jsonify({"message": str(e)})
    db.session.refresh(user)  # Refresh the user object to update its state in case of a successful login
